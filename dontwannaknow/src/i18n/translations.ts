...
const STRINGS: Record<Lang, StringSet> = {
  cs: {
    ...
    "form.err.date2": "Napiš prosím rok narození — třeba 1953.",
    "form.err.empty": "Přidej alespoň jednu osobu s rokem narození.",
    "results.explore": "Prozkoumat dál",
    "results.expandAll": "Rozbalit vše",
    "results.collapseAll": "Sbalit vše",
    "results.newWorld": "← Nový svět",
    "results.readStory": "Přečíst si to jako příběh →",
    "results.readComparison": "Přečíst si srovnání →",
    "results.collapseStory": "sbalit",
    "results.fullStory": "Celý příběh",
    "results.comparison": "Srovnání",
  ...
  en: {
    ...
    "form.err.date2": "Please enter a birth year — e.g. 1953.",
    "form.err.empty": "Add at least one person with a birth year to see the facts.",
    "results.explore": "Explore further",
    "results.expandAll": "Expand all",
    "results.collapseAll": "Collapse all",
    "results.newWorld": "← New world",
    "results.readStory": "Read it as a story →",
    "results.readComparison": "Read the comparison →",
    "results.collapseStory": "collapse",
    "results.fullStory": "The full story",
    "results.comparison": "The comparison",
