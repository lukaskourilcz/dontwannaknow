...
const STRINGS: Record<Lang, StringSet> = {
  cs: {
    ...
    "form.intro":     "Zadej rok narození (nebo celé datum — např. 1953-04-12, 12/04/1953, nebo 04/1953), zemi a město pro každou osobu. Celé datum odemkne mapu hvězd v noci jejich narození. Pole „návštěv/rok\" je volitelné — pokud ho vyplníš, report ti řekne, kolik setkání ti s nimi nejspíš zbývá.",
    ...
    "form.meetings":  "návštěv/rok",
    "form.meetings.help": "Volitelné: kolikrát do roka se s nimi vidíš?",
  ...
  en: {
    ...
    "form.intro":     "Enter a birth year (or full date — e.g. 1953-04-12, 12/04/1953, or 04/1953), country, and city for each person. Adding a full date unlocks a sky chart of the night they were born. The 'visits/yr' field is optional — fill it in to see how many meetings you've likely got left.",
    "form.note.english": "",
    "form.you":       "You",
    "form.parent":    "Mom / Dad",
    ...
    "form.meetings":  "visits/yr",
    "form.meetings.help": "Optional: how many times per year do you see this person?",
