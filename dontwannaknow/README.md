...
Řídicí produktová pravidla, reviewer agenti a příkazy jsou v kořenovém [`CLAUDE.md`](../CLAUDE.md). Audit redesignu a stav odložených médií jsou v [`docs/experience-overhaul.md`](../docs/experience-overhaul.md) a [`docs/generated-media.md`](../docs/generated-media.md).
